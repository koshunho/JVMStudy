...
![栈帧](koshunhopic.s3-cn-south-1.qiniucs.com/小书匠/栈帧.png)
...
![堆内存逻辑](koshunhopic.s3-cn-south-1.qiniucs.com/小书匠/堆内存逻辑.png)


GC主要是在新生区和老年区，又分为**轻GC** 和 **重GC**，如果内存不够or存在死循环，就会导致 OOM错误

![堆结构](koshunhopic.s3-cn-south-1.qiniucs.com/小书匠/堆结构.png)
...
![VM参数调优](koshunhopic.s3-cn-south-1.qiniucs.com/小书匠/VM参数调优.png)
...
![结果1](koshunhopic.s3-cn-south-1.qiniucs.com/小书匠/GC1.png)
![结果2](koshunhopic.s3-cn-south-1.qiniucs.com/小书匠/GC2.png)
...
#### 引用计数法
![引用计数法](koshunhopic.s3-cn-south-1.qiniucs.com/小书匠/引用计数法.png)
...
![复制算法](koshunhopic.s3-cn-south-1.qiniucs.com/小书匠/复制算法.png)
...
![标记清除算法](koshunhopic.s3-cn-south-1.qiniucs.com/小书匠/标记清除.png)
...
#### 标记压缩算法
![标记压缩算法](koshunhopic.s3-cn-south-1.qiniucs.com/小书匠/标记压缩.png)
